		...
		switch (action) {
			...
			case MotionEvent.ACTION_MOVE:
				if (onscrollTopListener!=null){
					onscrollTopListener.onscrollTop(this.getScrollY());
				}
				Log.d("sss1234213",this.getScrollY()+"  pp333");
				float dy = y - mLastY;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		switch (action) {
			case MotionEvent.ACTION_DOWN:
				...
				return true;
			case MotionEvent.ACTION_MOVE:
				Log.d("sss1234213",this.getScrollY()+"  pp");
				float dy = y - mLastY;
